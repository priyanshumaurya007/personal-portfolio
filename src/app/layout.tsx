...
export const metadata: Metadata = {
  title: 'Priyanshu Maurya | Backend Engineer — FinTech & Blockchain',
  description:
  ...
  authors: [{ name: 'Priyanshu Maurya' }],
  creator: 'Priyanshu Maurya',
  openGraph: {
    type: 'website',
    locale: 'en_IN',
    title: 'Priyanshu Maurya | Backend Engineer — FinTech & Blockchain',
    ...
    siteName: 'Priyanshu Maurya Portfolio',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Priyanshu Maurya | Backend Engineer',
